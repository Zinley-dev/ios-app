...
extension UIColor {
    ...
    static let dimmedDarkestOrangeBackground = UIColor(red: 246, green: 159, blue: 4)
...
extension EKColor {
    ...
    static var noteBackground: EKColor {
        return EKColor(UIColor.by(r: 3, g: 152, b: 252)) // Light blue in RGB
    }
    ...
    static var dimmedDarkestOrangeBackground: EKColor {
        return EKColor(light: .dimmedDarkestOrangeBackground,
                       dark: .dimmedDarkestOrangeBackground)
    }
