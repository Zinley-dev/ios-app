...
extension ApprovedStitchVC: ASCollectionDelegate {
    ...
    func collectionNode(_ collectionNode: ASCollectionNode, constrainedSizeForItemAt indexPath: IndexPath) -> ASSizeRange {
        ...
        if collectionNode == myCollectionNode {
            ...
            let height = self.stitchedView.layer.frame.height
            let width = self.stitchedView.layer.frame.width
...
extension ApprovedStitchVC {
    ...
    func setupCollectionNode() {
        ...
        // Add the collection node's view as a subview and set constraints
        self.stitchedView.addSubview(waitCollectionNode.view)
        self.waitCollectionNode.view.translatesAutoresizingMaskIntoConstraints = false
        self.waitCollectionNode.view.topAnchor.constraint(equalTo: self.stitchedView.topAnchor, constant: 0).isActive = true
        self.waitCollectionNode.view.leadingAnchor.constraint(equalTo: self.stitchedView.leadingAnchor, constant: 0).isActive = true
        self.waitCollectionNode.view.trailingAnchor.constraint(equalTo: self.stitchedView.trailingAnchor, constant: 0).isActive = true
        self.waitCollectionNode.view.bottomAnchor.constraint(equalTo: self.stitchedView.bottomAnchor, constant: 0).isActive = true
